...
(function(a){
    a.fn.amazon_scroller=function(p){
        ...
        var o=p&&p.scroller_title_size?p.scroller_title_size:"0.1";
        ...
        dom.find(".amazon_scroller_nav").children("li").hover(
            function(){
                if($(this).parent().children().index($(this))==0){
                    ...
                    $(this).css("background-position","right -135px");
                }
            },
            function(){
                if($(this).parent().children().index($(this))==0){
        ...
        function begin(){
            ...
            dom.children(".amazon_scroller_mask").width(u);
            dom.children(".amazon_scroller_mask").height(v);
            dom.find(".amazon_scroller_nav").css('top',(v-261)/2+parseInt(j)+"px");
        ...
        function s_s_nav(a,d){
            ...
            a.children("li").css("height","135px");
